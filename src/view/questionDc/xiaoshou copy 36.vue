<template>
  <div style="font-size:14px;padding-bottom:53px;" class="all_change_box">
          ...
          <div v-if="item.select_type=='radio'">
            ...
            <span style="display:block;">
              <el-button
                ...
                @click="item.select_link=='el-icon-view'?bfjlHandle():item.select_link=='el-icon-connection'?khgxHandle(item.select_link):item.select_link=='el-icon-search'?zpxqHandle(item):item.select_link=='el-icon-set-up'?khgxHandle(item.select_link):item.select_link=='el-icon-thumb'?ggxzHandle(item):item.select_link=='el-icon-check'?khgxHandle(item.select_link):''"
          ...
          <div v-if="item.select_type=='no'">
            ...
            <span style="display:block;">
              <el-button
                ...
                type="primary"
                :icon="item.select_link"
                @click="item.select_link=='el-icon-view'?bfjlHandle():item.select_link=='el-icon-connection'?khgxHandle(item.select_link):item.select_link=='el-icon-search'?zpxqHandle(item):item.select_link=='el-icon-set-up'?yjjlHandle(item.select_link):item.select_link=='el-icon-thumb'?ggxzHandle(item):item.select_link=='el-icon-check'?xzryHandle(item.select_link):''"
              >{{item.select_link_name}}</el-button>
            </span>
          </div>
    ...
    >
      <div style="margin:0 10px 10px;" class="clearfix">
        <el-date-picker
      ...
      <div class="qu_bfcard">
        <div class="qu_bfcard_box" v-for="(item,index) in bfjlData" :key="index">
          ...
          <div class="qu_card_cont_bf">
            ...
            <p class="qu_bfcard_b">
              <span>开始/结束：</span>
              <span>{{item.start_time?item.start_time+'---':''}}{{item.end_time}}</span>
            </p>
          </div>
        </div>
      </div>
    ...
    >
      <div class="qu_card">
        ...
        >
          ...
          <div v-if="item.is_show" class="qu_card_b clearfix">
            <p v-if="item.phone">
              <i class="el-icon-phone qu_card_b_icon"></i>
              {{item.phone}}
            </p>
            <p v-if="item.contact_person_email">
              <i class="el-icon-message qu_card_b_icon"></i>
              {{item.contact_person_email}}
            </p>
            <p v-if="item.birthday">
              <i class="el-icon-date qu_card_b_icon"></i>
              {{item.birthday}}
            </p>
            <p v-if="item.remark">
              <i class="el-icon-tickets qu_card_b_icon"></i>
              {{item.remark}}
            </p>
          </div>
    ...
    >
      ...
      >
        <div class="qu_open_a">
          ...
          <div class="qu_ta_a2">
            <el-radio-group v-model="item.need">
        ...
        <div class="qu_open_a">
          ...
          <div class="qu_ta_a2">
            <el-select style="width:100%;" size="mini" v-model="item.section" placeholder="请选择部门">
              <el-option
        ...
        <div v-if="item.need=='是'">
          <div class="qu_open_a">
            ...
            <div class="qu_ta_a2">
              <el-input size="mini" style="width:100%;" v-model="item.username" placeholder="请输入姓名"></el-input>
            </div>
          </div>
          <div class="qu_open_a">
          ...
          <div class="qu_open_a">
            ...
            <div class="qu_ta_a2">
              <el-input size="mini" style="width:100%;" v-model="item.phone" placeholder="请输入电话"></el-input>
            </div>
          </div>
          <div class="qu_open_a">
            <span class="qu_ta_a1 qu_pos_top">邮箱：</span>
            <div class="qu_ta_a2">
              <el-input size="mini" style="width:100%;" v-model="item.email" placeholder="请输入邮箱"></el-input>
            </div>
          </div>
          <div class="qu_open_a">
            <span class="qu_ta_a1 qu_pos_top">
        ...
        <div v-if="item.need=='否'">
          <div class="qu_open_a">
            ...
            <div class="qu_ta_a2">
              <el-input size="mini" style="width:100%;" v-model="item.zpzhiwei" placeholder="请输入职位"></el-input>
            </div>
          </div>
          <div class="qu_open_a">
            <span class="qu_ta_a1 qu_pos_top">
            ...
            <div class="qu_ta_a2">
              <el-input size="mini" style="width:100%;" v-model="item.zpnumber" placeholder="请输入人数"></el-input>
          ...
          <div class="qu_open_a">
            ...
            <div class="qu_ta_a2">
              <el-input size="mini" v-model="item.zpmoney1" style="width:80px;" placeholder="金额"></el-input>-
              <el-input size="mini" v-model="item.zpmoney2" style="width:80px;" placeholder="金额"></el-input>
            </div>
          </div>
          <div class="qu_open_a">
            <span class="qu_ta_a1 qu_pos_top">
