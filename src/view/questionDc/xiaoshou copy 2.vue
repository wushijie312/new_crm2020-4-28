  ...
  <div class="qu_box" style="font-size:14px;">
    <div class="qu_body">
      ...
      <div>
        ...
        <div>
          <el-radio class="all_block" v-model="a_income1" label="扩大收入">扩大收入</el-radio>
          <el-radio class="all_block" v-model="a_income1" label="稳定收入">稳定收入</el-radio>
      ...
      <div class="m_t10">
        2、扩大/稳定该客户收入主要问题是什么？
        <div>
          <el-radio class="all_block"  v-model="a_question1" label="控制成本">控制成本</el-radio>
          <el-radio class="all_block"  v-model="a_question1" label="增加品类">增加品类</el-radio>
          <el-radio class="all_block"  v-model="a_question1" label="创意方案">创意方案</el-radio>
      ...
      <div class="m_t10">
        3、是否考虑现场驻场服务，为什么？
        <div>
          <el-radio class="all_block"  v-model="a_fuwu1" label="是">是</el-radio>
          <el-radio class="all_block"  v-model="a_fuwu1" label="否">否</el-radio>
        </div>
        <el-input
          size="mini"
          type="textarea"
      ...
      <div class="m_t10">
        ...
        <div>
          <el-radio class="all_block"  v-model="a_demand1" label="是">是</el-radio>
          <el-radio class="all_block"  v-model="a_demand1" label="否">否</el-radio>
        </div>
        <el-input
          size="mini"
          type="textarea"
      ...
      <div class="m_t10">
        ...
        <div>
          <el-radio class="all_block"  v-model="a_action1" label="控制成本">控制成本</el-radio>
          <el-radio class="all_block"  v-model="a_action1" label="增加品类">增加品类</el-radio>
          <el-radio class="all_block"  v-model="a_action1" label="创意方案">创意方案</el-radio>
          <el-radio class="all_block"  v-model="a_action1" label="保证交期">保证交期</el-radio>
      ...
      <div>
        ...
        <div>
          <el-radio class="all_block"  v-model="b_guimo1" label="0万">0万</el-radio>
          <el-radio  class="all_block" v-model="b_guimo1" label="1万-100万">1万-100万</el-radio>
          <el-radio class="all_block"  v-model="b_guimo1" label="101-1000万">101-1000万</el-radio>
          <el-radio class="all_block"  v-model="b_guimo1" label="1001万-1亿">1001万-1亿</el-radio>
      ...
      <div class="m_t10">
        ...
        <div>
          <el-checkbox-group v-model="b_pinlei1">
            <el-checkbox  class="all_block_checked"  label="印刷"></el-checkbox>
            <el-checkbox class="all_block_checked"  label="服装"></el-checkbox>
            <el-checkbox  class="all_block_checked" label="包材"></el-checkbox>
            <el-checkbox class="all_block_checked"  label="礼品"></el-checkbox>
            <el-checkbox class="all_block_checked"  label="数码工装"></el-checkbox>
            <el-checkbox label="其它" style="margin-right:30px;"></el-checkbox>
          <el-input style="width:150px;" size="mini" placeholder="请输入密码" v-model="a_action11" ></el-input>
      ...
      <div class="m_t10">
        ...
        <div>
          <el-radio  class="all_block" v-model="b_shouru1" label="0万">0万</el-radio>
          <el-radio class="all_block"  v-model="b_shouru1" label="1万-100万">1万-100万</el-radio>
          <el-radio  class="all_block" v-model="b_shouru1" label="101-1000万">101-1000万</el-radio>
          <el-radio  class="all_block" v-model="b_shouru1" label="1001万-1亿">1001万-1亿</el-radio>
