<template>
  <div class="qu_box" style="font-size:14px;text-align:left;max-width:850px;margin:0 auto;">
...
import Zhanlv from "./zhanlv";
import Hrzc from "./hr";
import Gaoguan from "./gaoguan";
import Pinlei from "./pinlei";
