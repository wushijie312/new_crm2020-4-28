    ...
    <div class="tabs_two_box" v-for="(item,len1) in tabdata3" :key="len1">
      <div class="tabs_info">
        ...
        <div :class="item.is_act?'tabs_two act':'tabs_two'">
          ...
          <div v-if="item.saleNo>5&&searchValue3!='实时完成率' &&item.saleNo<=tabdata3.length-5 &&tabdata3xskword.length==tabdata3.length" class="tabs_normal_cont tabs_lc tabs_lmoney">***</div>
