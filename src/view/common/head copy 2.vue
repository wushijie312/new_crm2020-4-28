  ...
  <div>
    ...
    >
      ...
      <router-link
        ...
        style="background:#fff;text-decoration: none;borderTop:1px solid #eee;padding:15px 0; text-align:center;line-height:20px;fontSize:16px;color:#3face8;display: block;position: absolute;width: 100%;bottom: 0;"
      >
        <img
          :src="back_home"
